        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item">
                <a className="nav-link disabled" href="/" aria-disabled="true">About Us</a>
              </li>
            </ul>
            <form className="d-flex" name='d-flex' role="search">
            ...
            <div className="form-check form-switch mx-3">
                <input className="form-check-input" type="checkbox" onClick={props.tog} role="switch" id="flexSwitchCheckDefault"/>
